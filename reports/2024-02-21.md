...
* Individual member contributions
    ...
    * Ian
        ...
        * Progress and issues
            * I was able to work more on the move suggestion API, but was unable to fully implement the feature to the extension. I have thought about details on a high level, but will continue to work on it this week.
        * Goals for the next week
            * For this upcoming week, I plan to finalize the API further and implement it with the extension.
               * This involves working with other team members to handle testing and other error handling.
    * Fahad
        * Goals from the previous week
            * Fix up the code for the move analysis so that it will work with the Vercel limits (2 days)
            * Work on the backend for the Pokemon info queries (2 days)
